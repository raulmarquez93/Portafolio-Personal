...
var _darkMode = require("./scripts/darkMode");
...
},{"./scripts/scrollReveal":"54rka","./scripts/tiltAnimation":"72kAb","./data/scrollRevealConfig":"5aORV","./scripts/darkMode":"fhq9C","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"54rka":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fhq9C":[function(require,module,exports) {
// // darkMode.js
...
// Al cargar la página, revisa la preferencia guardada
window.onload = ()=>{
    if (localStorage.getItem("mode") === "dark") applyDarkMode();
    else removeDarkMode();
};
// Alternar modo y guardar la preferencia
...
},{}]},["farZc","8lqZg"], "8lqZg", "parcelRequire6aa4")
